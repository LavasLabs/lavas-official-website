      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            <h1 className="text-5xl font-bold mb-6">EXPENSE MANAGEMENT SOFTWARE DESIGNED TO CLOSE YOUR BOOKS FASTER</h1>
            <p className="text-xl mb-8">Automated expense software built into your corporate card, reimbursements, and more</p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 border rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Save more by preventing out-of-policy spend</h3>
              <p className="text-gray-600">Preset controls on corporate cards for specific vendors and categories.</p>
            </div>
            <div className="p-6 border rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Be free from expense reports</h3>
              <p className="text-gray-600">Easily submit expenses through SMS, mobile app, and integrations.</p>
            </div>
            <div className="p-6 border rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Unlock savings in real time</h3>
              <p className="text-gray-600">Get insight into spend as it happens, with a platform that pays off immediately.</p>
            </div>
            <div className="p-6 border rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Grow your business with the right terms</h3>
