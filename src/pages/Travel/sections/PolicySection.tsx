...
const PolicySection = () => {
  ...
  return (
    <section className={`w-full max-w-[1920px] mx-auto box-border bg-[#FFF] flex justify-center items-center flex-col text-[#0A0B11] ${isMobile ? 'px-0 py-[50px] h-auto' : 'px-[clamp(40px,16%,310px)] py-[170px] min-h-screen '}`}>
