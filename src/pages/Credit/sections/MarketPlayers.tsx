...
const cardData = [
  {
    icon: 'Booster',
    description: 'Mirror the investment strategies of large corporations with the Volcano Booster.'
  },
  {
    icon: 'property2',
    description: 'Use your holdings as collateral to acquire up to 3x more digital assets.'
  },
  {
    icon: 'limit',
    description: 'Use your holdings as collateral to acquire up to 3x more digital assets.'
...
const MarketPlayers = () => {
    ...
    const Card = ({ icon, description }: { icon: string; description: string }) => (
            ...
            <div className={`w-full max-w-[600px] box-border mx-auto text-center text-[#FFF] relative ${
              isMobile ? 'px-[20px] mt-[2%]' : 'mt-[10%]'
                ...
                <div className={`font-[700] leading-[1.2] ${
                  ...
                  PLAY THE MOVES OF MAJOR MARKET PLAYERS.
                </div>
            </div>
