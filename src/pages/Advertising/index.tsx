      ...
      <section className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            <h1 className="text-5xl font-bold mb-6">全球广告投放解决方案</h1>
            <p className="text-xl mb-8">为您的品牌提供全球化的广告投放服务，助力业务增长，实现全球化营销目标。</p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold mb-6">全方位的广告投放服务</h2>
              <p className="text-gray-600 mb-8">我们提供专业的全球广告投放解决方案，帮助您的品牌在全球市场获得更大的曝光度。</p>
            ...
            <div className="relative">
              <div className="bg-gray-900 rounded-lg p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">广告投放优势</h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-white rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold mb-4">全球化网络</h3>
              <p className="text-gray-600">覆盖全球主要市场的广告资源网络，确保您的品牌信息传递到目标受众。</p>
            </div>
            <div className="p-6 bg-white rounded-lg shadow-sm">
              <h3 className="text-xl font-semibold mb-4">智能优化</h3>
