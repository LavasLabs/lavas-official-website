...
const Travel = () => {
  ...
  return (
    <>
      ...
      {/* 第二页 */}
      <section className='text-[#0A0B11] px-[clamp(40px,16%,310px)] py-[170px] w-full max-w-[1920px] mx-auto min-h-screen box-border pt-[clamp(60px,10vh,100px)] bg-[#FFF] flex justify-center items-center flex-col'>
      ...
      <section className='text-[#0A0B11] w-full box-border bg-[#FFF] mb-[170px] flex items-center flex-col min-h-screen'>
        ...
        <div className='mt-[clamp(30px,5vh,40px)] w-full min-h-[800px] bg-[url("/images/travel-oversee-bg.png")] bg-cover bg-no-repeat bg-center pl-[clamp(40px,16%,310px)] pb-[10%] pr-[105px] py-[clamp(40px,8vh,80px)] flex justify-between  gap-[clamp(20px,4vw,40px)] box-border'>
